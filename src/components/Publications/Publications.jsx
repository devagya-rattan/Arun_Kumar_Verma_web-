        ...
        <div className="p-6 sm:p-8">
          <div className="divide-y divide-gray-200">
            ...
            <p className="text-xs sm:text-sm text-gray-600 mt-2 sm:mt-4 text-center">
              Akashdeep Sharma, Himani Vaid, Riya Kotwal, Zuhaib N. Mughal, and
              Ramani Gurubrahamam*
            </p>
          </div>
          ...
          <p className="text-sm sm:text-base text-gray-700 mt-4 leading-relaxed">
            ...
            densely functionalized α-alkynyl α-amino esters are obtained in good
            to excellent yields. Further, chemoselective N–H insertion
