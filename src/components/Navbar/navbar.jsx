      ...
      <div className="w-full md:pl-40 pl-6 pt-2 md:pr-40 pr-6 flex flex-col">
        <div className={`flex flex-row h-14 justify-between items-center`}>
          ...
          <div className="hidden xl:flex space-x-3">
            ...
            <Link
              className="roberto text-base pl-2 font-bold hover:opacity-40 cursor-pointer"
              to="/blog"
            >
              Blog
            </Link>
          ...
          {/* Mobile menu */}
          <div
            className={`absolute xl:hidden top-20 left-0 w-full bg-white flex flex-col items-center gap-6 font-semibold text-lg transform transition-transform ${
          ...
          >
            <li className="list-none w-full text-center p-4 cursor-pointer">
              <Link
                className="roberto text-base font-bold hover:opacity-40"
                to="/"
                onClick={toggle}
              >
                Home
